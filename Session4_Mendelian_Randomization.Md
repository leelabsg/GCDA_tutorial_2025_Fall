...
You can check the list of available data obtainable from IEU using available_outcomes().ao 
```
...
(Optional) You can import your own GWAS summary for exposure data, as well.
```
