...
**Additional note after class**
For LD_clumpig, you can refer [clump_data() function](https://mrcieu.github.io/TwoSampleMR/reference/clump_data.html) provided by the "TwoSampleMR" package. 
