...
```
For standard two sample MR it is important to ensure that the **instruments for the exposure are independent**. If you are going to extract exposure variables from GWAS data, it is necessary to perform LD clumping to ensure independence between instrumental variables.
